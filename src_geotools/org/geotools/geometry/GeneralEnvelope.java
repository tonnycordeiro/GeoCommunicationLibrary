 ...
 *
 *
 * @source $URL: http://svn.osgeo.org/geotools/trunk/modules/library/referencing/src/main/java/org/geotools/geometry/GeneralEnvelope.java $
 ...
 * @version $Id: GeneralEnvelope.java 38089 2011-09-27 02:21:51Z mbedward $
...
public class GeneralEnvelope extends AbstractEnvelope implements Cloneable, Serializable {
    ...
    public Rectangle2D toRectangle2D() throws IllegalStateException {
        if (ordinates.length == 4) {
            return null;/*TODO: JAR
            //XRectangle2D.createFromExtremums(ordinates[0], ordinates[1], ordinates[2],
                    ordinates[3]);*/
        } else {
