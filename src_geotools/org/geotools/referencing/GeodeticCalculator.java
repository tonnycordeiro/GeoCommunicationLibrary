 ...
 *
 *
 * @source $URL: http://svn.osgeo.org/geotools/trunk/modules/library/referencing/src/main/java/org/geotools/referencing/GeodeticCalculator.java $
 * @version $Id: GeodeticCalculator.java 38089 2011-09-27 02:21:51Z mbedward $
...
public class GeodeticCalculator {
     ...
     * @since 2.3
     */
    public void setStartingGeographicPoint(final GeodesicPosition point) throws IllegalArgumentException {
     ...
     * @since 2.3
     */
    public GeodesicPosition getStartingGeographicPoint() {
        return new GeodesicPosition(toDegrees(long1), toDegrees(lat1));
    }
     ...
     * @since 2.3
     */
    public void setDestinationGeographicPoint(final GeodesicPosition point)
            throws IllegalArgumentException
    {
     ...
     * @since 2.3
     */
    public GeodesicPosition getDestinationGeographicPoint() throws IllegalStateException {
        if (!destinationValid) {
            computeDestinationPoint();
        }
        return new GeodesicPosition(toDegrees(long2), toDegrees(lat2));
    }
