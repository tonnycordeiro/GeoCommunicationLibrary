...
/*import geometry.ShapeUtilities;*/
 ...
 *
 *
 * @source $URL: http://svn.osgeo.org/geotools/trunk/modules/library/referencing/src/main/java/org/geotools/referencing/operation/transform/AbstractMathTransform.java $
 * @version $Id: AbstractMathTransform.java 38089 2011-09-27 02:21:51Z mbedward $
...
public abstract class AbstractMathTransform extends Formattable implements MathTransform {
    ...
    public Shape createTransformedShape(final Shape shape) throws TransformException {
    	/*TODO: JAR*/
        return null;
        		/*isIdentity() ? shape : createTransformedShape(shape, null, null, ShapeUtilities.PARALLEL);*/
    }
            ...
            throws TransformException
    {
        ...
        for (; !it.isDone(); it.next()) {
            ...
            final Point2D ctrlPoint = null;
            /*TODO: jar*/
            /*ShapeUtilities.parabolicControlPoint(px, py,
                                                     buffer[0], buffer[1],
                                                     buffer[2], buffer[3],
                                                     orientation, ctrl);*/
            px = buffer[2];
        ...
        return null;
        /*TODO: JAR*/
        /*ShapeUtilities.toPrimitive(path);*/
    }
