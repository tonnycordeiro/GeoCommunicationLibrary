 ...
 *
 *
 * @source $URL: http://svn.osgeo.org/geotools/trunk/modules/library/referencing/src/main/java/org/geotools/referencing/operation/builder/LocalizationGrid.java $
 * @version $Id: LocalizationGrid.java 38089 2011-09-27 02:21:51Z mbedward $
 * @author Remi Eve
...
public class LocalizationGrid {
    ...
    private MathTransform2D fitWarps(final int degree) {
        ...
        /*TODO: JAR*/
        return null;/*new WarpTransform2D(null, srcCoords, 0, null, dstCoords, 0, warpOffset/2, degree);*/
    }
