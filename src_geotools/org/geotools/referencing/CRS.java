 ...
 * @version $Id: CRS.java 38754 2012-05-25 04:38:04Z jive $
  ...
  loop: while (true) {
            ...
            throws TransformException
    {
        ...
        if (destination != null) {
        	...
        	/*TODO: incluir JAR*/
            destination = null;/*XRectangle2D.createFromExtremums(xmin, ymin, xmax, ymax);*/
        }
        ...
        /*assert (destination == envelope || !(destination instanceof Rectangle2D.Double ||
                ...
                XRectangle2D.equalsEpsilon(destination,transform(transform, new Envelope2D(null, envelope)).toRectangle2D()) : destination;*/
        return destination;
    }
